...
| Agent | 角色 | 模型 | 一句话职责 |
|-------|------|------|-----------|
| **main** 🎓🏅📋👥✍️ | 顾问·教练·PM·HR·总编辑 | deepseek-v4-pro | 用户的唯一接口，需求入口，结果出口，团队调度 |
| **coder** 🏗️🖥️ | 架构师·驾驶员 | deepseek-v4-pro | 设计编码，与 codereviewer 结对编程 |
| **codereviewer** 🔍🧭 | 审查员·导航员 | zai/glm-5.1 | 代码审查+结对编程，与 coder 互补 |
| **tester** 🧪 | 测试 | moonshot/kimi-k2.6 | 黑盒+白盒+性能测试，保证代码质量 |
| **auditor** 🔒 | 审计·守门员 | deepseek-v4-pro | 前置审计+终审+性能标准 |
| **publicist** ✍️ | 写手 | deepseek-v4-pro | 技术文档、润色修改 |
